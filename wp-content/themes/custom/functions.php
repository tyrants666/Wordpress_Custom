...
define('CUSTOM_DIR',get_template_directory());
define('CUSTOM_DIR_URI',get_template_directory_uri());
...
if ( ! function_exists( 'custom_setup' ) ) :
	...
	function custom_setup() {
		...
		register_nav_menus(
			array(
				'primary-menu' => esc_html__( 'Primary', 'custom' ),
				'footer-menu' => esc_html__( 'Footer', 'custom' ),
			)
		);
 ...
 * Aq resizer
 */
require get_template_directory() . '/inc/lib/aq_resizer.php';
/**
 * Navwalker for multilevel menu
 */
require get_template_directory() . '/inc/lib/class-wp-bootstrap-navwalker.php';
/**
 * Asset Files
 */
